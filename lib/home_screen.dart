...
void initState() {
  ...
  if (!Amplify.isConfigured) {
    _status = 'Amplify not configured';
  } else {
    _status = 'Amplify already configured';
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            IconButton(
              icon: Icon(Icons.tune, size: 32, color: _selectedTab == 3 ? Colors.green : Colors.grey),
              splashRadius: 28,
              onPressed: () {
              ...
              child: IconButton(
                ...
                onPressed: () {
                  if (_selectedTab != 1) {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(builder: (_) => ScanPage(plantName: _selectedPlant)),
                    );
                  }
                },
              ),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ScanPage(plantName: _selectedPlant)),
                );
              },
