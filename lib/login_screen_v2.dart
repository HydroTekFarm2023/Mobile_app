...
class _LoginPageV2State extends State<LoginPageV2> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (res.isSignedIn) {
      ...
      } else if (res.nextStep.signInStep == 'confirmSignUp') {
        ...
        if (mounted) {
          ...
          Navigator.of(context).push(
            MaterialPageRoute(builder: (_) => const ConfirmSignUpPage()),
          );
        }
      } else {
  ...
  final msg = e.message;
  print('AuthException: $e');  // Add debug print
  if (msg.toLowerCase().contains('already') && msg.toLowerCase().contains('signed')) {
      ...
      setState(() => _authError = 'Auth Error: ${e.message}');
    } catch (e) {
