...
import 'package:strawberry_diagnosis/saved_scans.dart';
import 'dart:convert';
...
items.sort((a, b) => b.timestamp.compareTo(a.timestamp));
  ...
  Future<void> _saveScan(Diagnosis diagnosis) async {
    // For now, just show a snackbar
    // In a real app, you would save this to a separate "saved_scans" table in DynamoDB
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('${diagnosis.diseaseDetected} saved to Saved Scans')),
      );
    }
  }
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.of(context).push(
                MaterialPageRoute(builder: (_) => const SavedScansPage()),
              );
            },
          ),
        ],
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "Timestamp: ${diag.timestamp.toLocal().toString().split('.').first}",
